...
//      var backgroundheight_two = 0;

//   // Create a random offset for both images' starting positions
//         offset = Math.round(Math.floor(Math.random()* 431));
//         offset2 = Math.round(Math.floor(Math.random()* 431));
...
//       $('#container').css("background-position", "0% " + offset + "px");
...
//       $('#overlay').css("background-position", "0% " + offset2 + "px");
// });